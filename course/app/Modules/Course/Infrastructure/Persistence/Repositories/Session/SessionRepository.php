...
namespace App\Modules\Course\Infrastructure\Persistence\Repositories\Session;
...
class SessionRepository extends BaseRepositoryAbstract
{
    public function __construct()
    {
        $this->setModel(new ContentSession());
    }
