...
use App\Modules\Course\Infrastructure\Persistence\ApiService\Auth\TeacherApiService;
...
class AuthGuardServiceResolver
{
    public static function resolve(string $guard): ?AuthenticatesViaToken
    {
        return match ($guard) {
            ...
            AuthGurdTypeEnum::TEACHER->value      => new TeacherApiService(), // Assuming API uses UserApiService
